...
extern void UpdateSNTPTime(DWORD CurrentTimeInseconds);
#endif
#if defined (IRREADER)
extern void UpdateSNTPTime(DWORD CurrentTimeInseconds);
#endif
...
*/
	switch(SNTPState)
	{
		case SM_HOME:
           ...
           // putrsUART("SNTPSState:SM_HOME\r\n");
			
			break;

		case SM_NAME_RESOLVE:
			// Wait for DNS resolution to complete
		//	putrsUART("SNTPSState6:SM_NAME_RESOLVE\r\n");
		...
		//			putrsUART("SNTPSState6:!DNSRESOLVED\r\n");
				}
				break;
			}
			...
			if(!DNSEndUsage())
			{
				...
				dwTimer = TickGetDiv64K();
				SNTPState = SM_SHORT_WAIT;
		//		putrsUART("SNTPSState6:!DNSENDUSAGE\r\n");
				break;
			}
		...
		case SM_ARP_START_RESOLVE3:
			...
			dwTimer = TickGet();
			SNTPState++;
		//	putrsUART("SNTPSState:SM_ARP_START_RESOLVE3\r\n");
			break;
		...
		case SM_ARP_RESOLVE3:
			...
			//putrsUART("SNTPSState:SM_ARP_RESOLVE3\r\n");
		...
		//	putrsUART("SNTPSState:SM ARP RESOLVE FAIL\r\n");
		...
		case SM_UDP_SEND:
		//	putrsUART("SNTPSState2:SM UDP SEND\r\n");
		...
		case SM_UDP_RECV:
			...
			if(!UDPIsGetReady(MySocket)) 
			{
				if((TickGet()) - dwTimer > NTP_REPLY_TIMEOUT)
				{
					...
					dwTimer = TickGetDiv64K();
					SNTPState = SM_SHORT_WAIT;
			//		putrsUART("SNTPSState:UDPISGET READY\n");
					break;
			...
			dwTimer = TickGetDiv64K();
			SNTPState = SM_WAIT;
		//	putrsUART("SNTPSState1:SM UDP RECV\r\n");
...
//				UpdateSNTPTime(dwSNTPSeconds);
		...
		case SM_SHORT_WAIT:
			//putrsUART("SNTPSState: SM_SHORT_WAIT\r\n");
			...
			if(TickGetDiv64K() - dwTimer > (NTP_FAST_QUERY_INTERVAL/65536ull))
				{SNTPState = SM_HOME;
				//putrsUART("SNTPSState: NTP_FAST_QUERY_INTERVAL\r\n");	
				}
			break;
...
/*
putrsUART("Return time from SNTP function\r\n");
	char buf[30];
