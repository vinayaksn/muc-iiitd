...
extern 	BYTE *UartBuffPtr;
extern BYTE UartBuff[200];
extern BYTE TotalBytes;
extern BYTE TotalReadBytes;
extern DWORD EEPROMReadPtr;
extern unsigned char UnitName[16];
...
//			LED3_IO = 1;
		...
		XEEReadArray(EEPROMReadPtr,UartBuffPtr,TotalReadBytes);
		XEEEndRead();
		UartBuffPtr = UartBuff;	
