...
//					HttpADCPostPending = 0;
	...
	//	TotalReadBytes += 10;
			...
			TCPPutString(MySocket, (BYTE*)"POST ");
 			TCPPutString(MySocket, RemoteURL);
			TCPPutString(MySocket, (BYTE*)" HTTP/1.1\r\n");
 			TCPPutString(MySocket, (BYTE*)"Host: ");
 			TCPPutString(MySocket, ServerName);
 			TCPPutString(MySocket, (BYTE*)"\r\n");
		//	TCPPutString(MySocket, (BYTE*)"Connection: close");
		//	TCPPutString(MySocket, (BYTE*)"\r\n");
		//	TCPPutString(MySocket, (BYTE*)"Content-Type: text/html");
			TCPPutString(MySocket, (BYTE*)"Content-Type: application/x-www-form-urlencoded");
			TCPPutString(MySocket, (BYTE*)"\r\n");
 			TCPPutString(MySocket, (BYTE*)"Content-Length: ");
		//	TCPPutString(MySocket, (BYTE*)("50"));
			TCPPutString(MySocket, (BYTE*)("51"));
		//	TCPPut(MySocket, TotalReadBytesArray[0]);
		//	TCPPut(MySocket, TotalReadBytesArray[1]);
			TCPPutString(MySocket, (BYTE*)"\r\n\n");
			TCPPutString(MySocket, (BYTE*)buff);
		/*	TCPPutString(MySocket, (BYTE*)"PIR=");
			TCPPutString(MySocket, (BYTE*)UnitName);
			TCPPutString(MySocket, (BYTE*)PIR);
			TCPPutString(MySocket, (BYTE*)"&REED1=");
		//	TCPPutString(MySocket, (BYTE*)UnitName);
			TCPPutString(MySocket, (BYTE*)REED1);
			TCPPutString(MySocket, (BYTE*)"&REED2=");
		//	TCPPutString(MySocket, (BYTE*)UnitName);
			TCPPutString(MySocket, (BYTE*)REED2);
			TCPPutString(MySocket, (BYTE*)"&LM=");
		//	TCPPutString(MySocket, (BYTE*)UnitName);
			TCPPutString(MySocket, (BYTE*)LM);
			TCPPutString(MySocket, (BYTE*)"&LDR=");
		//	TCPPutString(MySocket, (BYTE*)UnitName);
			TCPPutString(MySocket, (BYTE*)LDR);
 		//	TCPPutString(MySocket, (BYTE*)LM);
 	*/
