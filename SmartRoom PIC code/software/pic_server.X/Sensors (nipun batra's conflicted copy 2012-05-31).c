...
SENSOR sensors[] = {
    {"temperature", '1', "0", ADC_READING_SIZE, (char *)temp1_reading, (float) 1, 0},
    {"pir", '1', "0", BIN_READING_SIZE, (char *)pir1_reading, (float) 1, 0},
    {"reed", '1', "0", BIN_READING_SIZE,(char *) reed1_reading, (float)1, 0}
};
...
void takeReading(unsigned short int sense_index) {
    ...
    switch (sense_index) {
        ...
        case 0:
        {
            ...
            sprintf(temp, "%04.1f", adc_value); // convert to string
            temp[4] = ',';
            temp[5] = '\0';
            lcd_putchar1(temp);
#endif
