...
static BYTE RemoteURL[] = "/data.php";

void HTTPADCPostTask(void);
extern BYTE HttpADCPostPending;
extern BYTE *ADCDataBuffPtr;
extern BYTE  ADCDataBuff[200];
