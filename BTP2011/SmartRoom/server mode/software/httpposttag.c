...
void HTTPTagPostTask(void);
extern BYTE HttpTagPostPending;
extern BYTE *TagDataBuffPtr;
extern BYTE  TagDataBuff[200];
...
//			LED3_IO = 1;
	...
	//	TotalReadBytes += 10;
		...
		//	TCPPutString(MySocket, (BYTE*)UnitName);
			TCPPutString(MySocket, (BYTE*)TagDataBuff);
